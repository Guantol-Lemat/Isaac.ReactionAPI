...
require("scripts.tables.enum")

require("scripts.tables.pickup_data")

require("scripts.tables.save")
...
require("scripts.api.functions")

require("scripts.compatibility.epiphany")

require("scripts.compatibility.cursed_collection")

require("scripts.tools.debug")